...
namespace TaskManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916210000_ImproveQueryIndexes")]
    partial class ImproveQueryIndexes
    {
            ...
            modelBuilder.Entity("TaskManager.Domain.Entities.ProjectMember", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "JoinedAtUtc", "UserId")
                        .HasDatabaseName("ix_project_members_active_project_joined_user")
            ...
            modelBuilder.Entity("TaskManager.Domain.Entities.TaskComment", b =>
                {
                    ...
                    b.HasIndex("TaskItemId", "CreatedAtUtc", "Id")
                        .HasDatabaseName("ix_task_comments_task_item_id_created_at_utc_id");
            ...
            modelBuilder.Entity("TaskManager.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "CreatedAtUtc", "Id")
                        .HasDatabaseName("ix_task_items_project_id_created_at_utc_id");
